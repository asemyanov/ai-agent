...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | MEVO',
    description: 'Replay this Agent conversation on MEVO',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | MEVO';
    const description =
      projectData.description ||
      'Replay this Agent conversation on MEVO';
