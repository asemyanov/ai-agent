...
export default function LicensePage() {
  return (
    <>
      <DocsHeader
        title="License"
        description="Mevo is open source software licensed under the Apache License, Version 2.0"
      ...
      <DocsBody className="w-full h-[40vh] px-8 py-16 relative overflow-hidden rounded-3xl flex items-center justify-center border bg-background mb-12">
        <h1 className="text-xl tracking-tight text-foreground text-center">
            <span className="font-semibold text-3xl">Mevo is open source under the Apache 2.0 License. You can see the source code, self-host & contribute.</span>
        </h1> 
        <Ripple/>
      </DocsBody>
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Mevo is distributed under the Apache License 2.0, one of the most permissive and business-friendly open source licenses available.
            This license allows you to use, modify, distribute, and sublicense Mevo for both commercial and non-commercial purposes.
          </p>
        </DocsBody>
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="check" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="Use Mevo for commercial purposes without any fees or royalties"
          />
          <DocsBulletItem
            title="Modification"
          ...
          <DocsBulletItem
            title="Distribution"
            description="Distribute original or modified versions of Mevo"
          />
          <DocsBulletItem
            title="Patent Use"
          ...
          <DocsBulletItem
            title="Private Use"
            description="Use and modify Mevo for private purposes without any obligations"
          />
          <DocsBulletItem
            title="Sublicensing"
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            When using Mevo under the Apache License 2.0, you must:
          </p>
        </DocsBody>
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="default" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="The license does not grant permission to use the trade names, trademarks, or service marks of Mevo"
          />
          <DocsBulletItem
            title="No Warranty"
        ...
        <Alert className="mb-8">
          <AlertDescription>
            <strong>Patent Retaliation Clause:</strong> If you initiate patent litigation against any entity alleging that Mevo constitutes patent infringement, 
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-primary pl-6">
            <h3 className="font-semibold mb-2">Can I use Mevo in my commercial product?</h3>
          ...
          <div className="border-l-4 border-primary pl-6">
            ...
            <p className="text-muted-foreground">
              You can apply different license terms to your modifications, but the original Mevo code remains under Apache 2.0.
            </p>
          </div>
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Learn more about the Apache License 2.0 and how to use Mevo:
          </p>
        </DocsBody>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <DocsCard
            title="Full License Text"
            description="Read the complete Apache License 2.0 text"
