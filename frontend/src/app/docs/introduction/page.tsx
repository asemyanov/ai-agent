  ...
  return (
    <>
      ...
      <DocsBody className="mb-8">
        <h2 id="overview">What is Mevo?</h2>
        <p className="text-lg mb-6">
          Mevo is an open source platform where you can build AI agents that handle real work. Think of it as the infrastructure and tools you need to create agents that can browse the web, manage files, analyze data, and automate workflows.
        </p>
        
        <h3 id="meet-mevo">Mevo - Our Flagship Agent</h3>
        <p className="mb-4">
          Mevo is our showcase agent that demonstrates what's possible with Mevo. It's a generalist AI worker that can:
        </p>
        ...
        <p className="mb-6">
          Mevo is completely open source and shows you what you can build with the Mevo platform.
        </p>
  
        <h3 id="build-your-own" className="mb-4">Build Your Own Agents</h3>
        <p className="mb-6">
          The real power comes when you create agents for your specific needs. Maybe you need an agent that monitors customer support tickets, or one that processes invoices, or handles your social media posting schedule. With Mevo, you get the building blocks to create agents that work exactly how you want them to.
        </p>

        <h3 id="how-it-works" className="mb-4">How It Works</h3>
        <p className="mb-4">Mevo gives you four main pieces:</p>
