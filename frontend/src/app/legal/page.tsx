                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE Agent
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      ...
                      <li>
                        "Site" refers to the Agent website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Agent website and all related
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Agent is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Agent logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE Agent WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      Agent DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Agent in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Agent does not collect biometric or identifying
